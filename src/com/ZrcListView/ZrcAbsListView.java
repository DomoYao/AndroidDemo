...
import com.Business.APIUtil;
import com.ZrcListView.ZrcListView.OnScrollListener;
import com.ZrcListView.ZrcListView.OnScrollStateListener;
...
public abstract class ZrcAbsListView extends ZrcAdapterView<ListAdapter>
    ...
    // 如果这是一个编译错误，需要设置您的构建目标（例如，项目>属性> Android的Eclipse中），以API等级19或更高。
